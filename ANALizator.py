...
class main_ui(QMainWindow, Form):
    ...
    def initUI(self):
        ...
        self.message.clicked.connect(lambda: QMessageBox.information(self, 'Баг-репорт', "Все обнаруженные баги - фичи"))
    ...
    def load_file_fun(self):
        ...
        if file != "":
            ...
            for i in lines:
                ...
                diction[i] = (programm, os , class_yazvim, date, yr_opas, status_yaz, nal_exploit, ystr_yaz, type_error, id)
